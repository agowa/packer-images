...
#
# Version 3.0.1-patch001 by Klaus Frank
# - Disabled 3DES
# - Disabled RC4
...
# Enable SCHANNEL EventLogging
New-ItemProperty -path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" -name 'EventLogging' -value '0x00000001' -PropertyType 'DWord' -Force | Out-Null
...
Write-Host -ForegroundColor Red 'Your server might allow insecure algorithems, that were disabled before until you perfom a reboot.'
