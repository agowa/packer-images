variable "vm_name" {
  type    = string
  default = "win_2019_standard_gui_en-US_template_-_latest"
}
...
variable "vcsa_autounattend" {
  type    = string
  default = "./answer-files/vcsa/win_2019_standard_gui/Autounattend.xml"
}
...
build {
  ...
  name    = "vcsa win 2019 standard gui en-US"
