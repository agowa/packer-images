variable "vm_name" {
  type    = string
  default = "win_2025_standard_core_en-US_template_-_latest"
}
...
variable "vcsa_autounattend" {
  type    = string
  default = "./answer-files/vcsa/win_2025_standard_core/Autounattend.xml"
}
...
build {
  ...
  name    = "vcsa win 2025 standard core en-US"
