variable "vm_name" {
  type    = string
  default = "win_2022_standard_core_en-US_template_-_latest"
}
...
variable "vcsa_autounattend" {
  type    = string
  default = "./answer-files/vcsa/win_2022_standard_core/Autounattend.xml"
}
...
build {
  ...
  name    = "vcsa win 2022 standard core en-US"
  ...
  provisioner "powershell" {
    ...
    scripts = [
      ...
      #"./scripts/Set-Windows2022ProductKey.ps1",
